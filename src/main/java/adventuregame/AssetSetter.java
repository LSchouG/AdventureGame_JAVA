...
public class AssetSetter {
    ...
    public void setObject() {
        ...
        if(Progress.grassDefeated == false) {
            gp.obj[mapNum][i] = new OBJ_DoorWood(gp);           // DOOR
    ...
    public void setInteractiveTiles() {
        ...
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp, 28, 48); i++;   // WALL
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp, 14, 53); i++;   //
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp, 15, 53); i++;   //
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp, 27, 48); i++;   // WALL
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp, 27, 49); i++;   // WALL
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp, 28, 49); i++;   // WALL
        ...
        gp.iTile[mapNum][i] = new IT_MetalPlate(gp, 15, 64);   // PETAL PLATES
