...
public class SaveLoad {
    ...
    public Entity getObject(String itemName){
        ...
        switch (itemName){
            ...
            case "Rock": obj = new OBJ_Rock_Projectile(gp); break;
