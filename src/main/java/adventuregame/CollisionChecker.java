    ...
    public void checkTile(Entity entity) {
        ...
        switch (direction) {
            case "up":
                ...
                tileNumber2 = gp.tileM.mapTileNumber[gp.currentMap][entityRightCol][entityTopRow];
            ...
            case "down":
                ...
                tileNumber1 = gp.tileM.mapTileNumber[gp.currentMap][entityLeftCol][entityBottomRow];
                tileNumber2 = gp.tileM.mapTileNumber[gp.currentMap][entityRightCol][entityBottomRow];
                if (gp.tileM.tile[tileNumber1] == null) {
                    System.err.println("Null tile at index: " + tileNumber1);
                }
                if (gp.tileM.tile[tileNumber1].collision || gp.tileM.tile[tileNumber2].collision) {
                    entity.collisionOn = true;
                }
            ...
            case "left":
                ...
                tileNumber1 = gp.tileM.mapTileNumber[gp.currentMap][entityLeftCol][entityTopRow];
                tileNumber2 = gp.tileM.mapTileNumber[gp.currentMap][entityLeftCol][entityBottomRow];
                if (gp.tileM.tile[tileNumber1].collision || gp.tileM.tile[tileNumber2].collision) {
                    entity.collisionOn = true;
                }
                break;
            ...
            case "right":
                ...
                tileNumber1 = gp.tileM.mapTileNumber[gp.currentMap][entityRightCol][entityTopRow];
                tileNumber2 = gp.tileM.mapTileNumber[gp.currentMap][entityRightCol][entityBottomRow];
                if (gp.tileM.tile[tileNumber1].collision || gp.tileM.tile[tileNumber2].collision) {
                    entity.collisionOn = true;
                }
